...
export function DropdownItem({
    ...
    const classes = clsx(
        ...
        // Focus
        "data-focus:bg-zinc-950/2.5 data-focus:text-slate-950 dark:data-focus:bg-zinc-950/25 dark:data-focus:text-white",
        // Disabled state
        ...
        "*:data-[slot=icon]:text-zinc-500 data-focus:*:data-[slot=icon]:text-zinc-950 dark:*:data-[slot=icon]:text-zinc-400 dark:data-focus:*:data-[slot=icon]:text-white",
        // Avatar
